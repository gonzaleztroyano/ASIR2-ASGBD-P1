...
CREATE TABLE IF NOT EXISTS `casicruzroja`.`mision` (
  ...
  PRIMARY KEY (`idmision`, `sede_idsede`, `equipo_id_equipo`, `envio_idenvio`),
...
CREATE TABLE IF NOT EXISTS `casicruzroja`.`envio_has_material` (
  ...
  INDEX `fk_envio_has_material_material1_idx` (`material_idmaterial` ASC) INVISIBLE,
  INDEX `fk_envio_has_material_envio1_idx` (`envio_idenvio` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `casicruzroja`.`colaborador_dona_material` (
  ...
  `cantidad` INT NULL,
  PRIMARY KEY (`colaborador_nif`, `material_idmaterial`, `fecha_donacion`),
  INDEX `fk_colaborador_has_material_material1_idx` (`material_idmaterial` ASC) VISIBLE,
  INDEX `fk_colaborador_has_material_colaborador1_idx` (`colaborador_nif` ASC) VISIBLE,
