...
CREATE TABLE IF NOT EXISTS `casicruzroja`.`socix` (
  ...
  `alta` DATE NULL,
  `baja` DATE NULL,
  PRIMARY KEY (`dni_socio`, `cod_postal_cod_postal`, `sede_idsede`, `evento_cod_evento`),
...
CREATE TABLE IF NOT EXISTS `casicruzroja`.`material` (
  ...
  `tipo` VARCHAR(45) NULL,
  `nombre` VARCHAR(45) NULL,
  `colaborador_nif` INT NULL,
  `cantidad_donada` INT NULL,
